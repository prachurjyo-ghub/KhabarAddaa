...
import { FiClock, FiShoppingBag, FiUser } from "react-icons/fi";
...
function statusTone(status: string) {
  ...
  if (s.includes("cancel")) return "text-red-300 border-red-400/30 bg-red-950/40";
  if (s.includes("deliver") || s.includes("complete"))
    return "text-emerald-300 border-emerald-400/30 bg-emerald-950/40";
  if (s.includes("prep") || s.includes("cook") || s.includes("progress"))
